...
void title(AppEnv& app_env,          Media& title_bgm,    Media& warp_bgm,
	      Texture& title_blacklien,Texture& title_lien, Texture& title,
		  Texture& click_to_hack,  Texture& zero_one,    Random& random,
		  float& box,        float& title_alpha, 
		   bool& title_action,bool& texture_bool,
		    int& start_count,  int& move)
{
